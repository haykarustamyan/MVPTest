...
public interface MVPTestDataSource {
    ...
    Observable<RemoveCommentHelpfulResponseEntity> removeCommentHelpful(int commentId);

    Observable<RemoveReplyHelpfulResponseEntity> removeReplyHelpful(int replyId);
}
